...
const socialsChartData = {
  'kfas-insta': {
    values: [63280, 63281, 63459, 63637, 65386, 69702, 70571, 77115, 79055, 79689, 80285, 93339],
    range: {
      min: 60000,
      max: 95000
    },
  ...
  'kfas-twitter': {
    values: [22097, 22212, 22239, 22212, 22335, 22427, 22427, 22553, 22598, 22694, 22712, 23279],
    range: {
      min: 21500,
      max: 23500,
    },
  ...
  'kfas-in': {
    values: [24459, 24459, 25683, 25683, 26566, 26944, 27380, 27543, 28001, 28459, 27789, 34946],
    range: {
      min: 24000,
      max: 35000,
    },
  ...
  'kfas-youtube': {
    values: [2156, 2156, 2167, 2167, 2170, 2183, 2194, 2222, 2233, 2242, 2246, 2390],
    range: {
      min: 2100,
      max: 2400,
    },
